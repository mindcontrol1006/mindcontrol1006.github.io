...
9. NPC  상호작용 및 퀘스트 시스템 구현<br>
   ...
   8-4 퀘스트 보상은 마을 주민들의 신뢰를 얻어 평판이 쌓이지만, 직접적으로 플레이어가 볼 수 있는 수치는 없고, 스토리 진행 시 마을에 더 환대를 받기 시작하고, 주 핵심은 스토리 길잡이 역할이다.<br>
   
10. 전투  시스템  구현<br>
    10-1 플레이어가 몬스터와 전투를 하면서 사망에 대한 처리로 게임이 종료되는 것을 잘 처리하는지 확인<br>
    10-2 몬스터가 사망한다면 정해진 리스폰 시간에 스폰 장소에 소환되는지 확인<br>
    10-3 피격과 데미지 처리가 잘 이루어지는지 확인<br>
    
11. 장비  아이템  착용  및  장비창 구현<br>
    11-1 장비 아이템은 몬스터 처치 시 획득할 수 있고 안내 메시지와 함께 자동으로 착용된다.<br>
